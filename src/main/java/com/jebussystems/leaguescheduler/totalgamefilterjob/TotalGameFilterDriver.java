...
public class TotalGameFilterDriver {

	private static final String JOB_NAME = "TOTAL_GAME_FILTER_JOB";

	public static void main(String[] args) throws Exception {

		// create the job configuraton
		JobConf conf = new JobConf(TotalGameFilterDriver.class);
		...
		conf.setReducerClass(TotalGameFilterReducer.class);
