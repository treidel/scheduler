...
public class VisitorGameSchedulerDriver {

	private static final Logger LOGGER = Logger.getLogger(VisitorGameSchedulerDriver.class);

	private static final String JOB_NAME = "VISITOR_GAME_SCHEDULER_JOB";
	...
	public static void main(String[] args) throws Exception {
		...
		conf.setReducerClass(VisitorGameSchedulerReducer.class);
